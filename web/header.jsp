	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
						...
						<ul class="navbar-nav">
							<li class="nav-item">
								<div class="input-group">
									<form>
										<input type="text" name="search" placeholder="프로젝트 검색.."></form>
									</div>
								</li>
							</ul>
		...
		%>
						...
						<div class="navbar_btn_group">
								<li class="nav-item">
									<a href="views/Member/signIn.jsp">
		...
		%>
									<ul class="nav navbar-nav navbar-right">
										<li>
											<a href="./views/Member/editSign.jsp">
												<span class="glyphicon glyphicon-user"></span>
												<%=member.getNick()%></a>
										</li>
										<li>
											<a href='views/Member/logout.jsp' style="width: auto;">
								...
								<% }else{ %>
									<ul id="right" class="nav navbar-nav navbar-right">
										<li>
											<a href="/Floracion/views/project/project_create_edit.jsp" class="glyphicon glyphicon-check">프로젝트생성하기</a>
										</li>
										<li>
											<a href="./views/Member/editSign.jsp">
												<span class="glyphicon glyphicon-user"></span>
							...
							<div id="id01" class="modal">
								...
								<div class="container">
									...
									<div class="imgcontainer">
										...
										<img src="img/user1.JPG" alt="Avatar" class="avatar"></div>
