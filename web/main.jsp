											...
											<table>
												<tr>
													<td>
														...
														<td>
															<img class="thumb_pics" src="./img/design.jpg" alt="Cinque Terre" width="300" height="300">
																<a class="thumb_text" href="./views/category/sub_category.jsp">디자인</a>
															</td>
															<td><img class="thumb_pics" src="./img/fashion.jpg" alt="Cinque Terre" width="300" height="300" <a class="thumb_text" href="./views/category/sub_category.jsp">패션</a>
														</td>
														<td>
															<img class="thumb_pics" src="./img/self_improvement.jpg" alt="Cinque Terre" width="300" height="300">
																<a class="thumb_text" href="./views/category/sub_category.jsp">자기계발</a>
															</td>
														</tr>
													</table>
												</div>
													...
													<br>
														<div class="row">
															<table>
																<tr>
																	<td>
																		<a href="./views/category/sub_category.jsp">
																			<img class="thumb_pics" src="./img/skill.jpg" alt="Cinque Terre" width="300" height="300"></a>
																		</td>
																		<td>
																			<img class="thumb_pics" src="./img/sport.jpg" alt="Cinque Terre" width="300" height="300"></td>
																			<td>
																				<img class="thumb_pics" src="./img/tech.jpg" alt="Cinque Terre" width="300" height="300"></td>
																				<td>
																					<img class="thumb_pics" src="./img/game.jpg" alt="Cinque Terre" width="300" height="300"></td>
																					<td>
																						<img class="thumb_pics" src="./img/fashion1.JPG" alt="Cinque Terre" width="300" height="300"></td>
																					</tr>
																				</table>
																			</div>
																		</div>
