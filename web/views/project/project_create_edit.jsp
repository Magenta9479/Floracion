			...
			<div class="container">
				<div class="row">
					<div class="board">
						...
						<form action="/Floracion/pcreate" method="POST"
							...
							<div class="tab-content">
								...
								<div class="tab-pane fade in active" id="home">
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											...
											<div class="form-group">
												<textarea name="pText" class="form-control" rows="2"
													id="comment"></textarea>
											</div>
										</div>
									</div>
								...
								<div class="tab-pane fade" id="profile">
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											...
											<label class="btn btn-default"> 파일찾기 <input
												name="pImage" type="file" hidden></label>
										</div>
									</div>
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											...
											<label class="btn btn-default"> 파일찾기 <input
												name="pVideo" type="file" hidden></label>
										</div>
									</div>
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											...
											<div class="form-group col-xs-3">
												<input name="pGMoney" class="form-control input-sm"
													id="inputsm" min="0" value="5000" dir="rtl" type="text"
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											...
											<div class="form-group row">
												...
												<div class="col-10">
													<input name="pSDate" class="form-control" type="date"
														value="2017-08-19" id="example-date-input">
												</div>
											</div>
											...
											<div class="form-group row">
												<label for="example-date-input" class="col-2 col-form-label">Date</label>
												<div class="col-10">
													<input name="pEDate" class="form-control" type="date"
														value="2017-08-19" id="example-date-input">
												</div>
											</div>
								...
								<div class="tab-pane fade" id="doner">
									...
									<p class="narrow text-center">
										...
										정보 수정은 이후에도 가능합니다. <br> <br>프로젝트가 다른 사용자들에게 보이기까지는 <br>등록
										요청 후 최대 3일까지 걸릴 수 있습니다.
									</p>

									<p class="text-center">
										<a class="btn btn-success btn-outline-rounded green"
											type="submit"> 생성 완료 및 등록 요청하기<span
											style="margin-left: 10px;" class="glyphicon glyphicon-ok"></span>
										</a>
									</p>
